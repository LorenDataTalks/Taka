    ...
    render() {
        return(
            ...
            <div className="badge-bottom"><span className="badge badge-primary">New</span></div><a href="user-profile.html">
              <h6 className="mt-3 f-14 f-w-600">Devambrose</h6></a>
            <p className="mb-0 font-roboto">Taka Resources Department</p>
            <ul>
              <li><span><span className="counter">10</span></span>
                <p>Follow</p>
              </li>
              <li><span>3 years</span>
                <p>Experince</p>
              </li>
              <li><span><span className="counter">95.2</span></span>
                <p>Follower </p>
              </li>
            </ul>
          </div>
